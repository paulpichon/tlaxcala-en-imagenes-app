  ...
  useEffect(() => {
    ...
    async function registerPush() {
      ...
      try {
        ...
        const res = await fetchWithAuth(`${process.env.NEXT_PUBLIC_API_URL}/api/notificaciones/vapidPublicKey`);
        ...
        const resp = await fetchWithAuth(`${process.env.NEXT_PUBLIC_API_URL}/api/notificaciones/subscribe`, {
          method: "POST",
