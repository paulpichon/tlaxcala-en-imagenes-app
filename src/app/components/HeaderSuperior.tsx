    ...
    return (
        <>
            <nav className="navbar-expand-lg menu_superior_central">
                <h1 className="titulo_principal_h1">
                    TLAXCALA EN 
                    <span className="display_inline_titulo">IMÁGENES</span>
                </h1>
                <h6 className="subtitulo_h6 por_tad">por 
                    <span className="span_tad d-block" data-bs-toggle="tooltip" data-bs-placement="right" title="Tlaxcala Al Descubierto">
                        T A D
                    </span>
                </h6>
            </nav>
