...
/**
 * Layout anidado para la página de eliminación de cuenta
 ...
 * 
 * NOTA CRÍTICA:
 * Esta es una de las páginas más sensibles de la aplicación
 * ya que permite al usuario eliminar permanentemente su cuenta.
 */
